$(document).ready(function() {
    ...
    console.log("hi from the src!")



    $("nav > div.logo").css('visibility','visible')
    $("nav > div.nav-toggle").css('visibility','visible')
    ...
    $(window).scroll(function() {
        ...
        if( scrollPosition < 50 || scrollPosition > $(this).height() - $("nav").height()  ) {
